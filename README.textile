...
A conductor initially seems similar to a "presenter":http://www.jayfields.com/rails_presenter.htm, particularly as the presenter example Jay Fields gives does manage multiple objects in order to keep the controller concise. However, the distinction in my mind is this:
