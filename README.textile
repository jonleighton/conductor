...
* Creating, finding or deleting associated objects as necessary
* Only performing database changes when told to and inside a transaction
* Aggregating the error messages occurring on associated objects

h2. Status

At the moment:

* Conductor is not "feature complete" or API-stable
* Clear, concise documentation is lacking
* It only works with PostgreSQL

However:

* I has almost 100% RSpec coverage
